...
false,'1010101001010',125563.141592,125563.141592,'101010101',456,97897,'2021-09-27 pst',123,INTERVAL '1 2:31:15.1250' DAY(1) TO SECOND(4),
0,rpad('abc','10','e'),353848,rpad('abc','10','exc'),lpad('abc','30','a@123&^%djgk'),lpad('abc','20','a@123&^%djgk'),9745.548,3141.5,-99,'2021-09-27 pst',to_timestamp('2019-01-04 16:33:47.123456','YYYY-MM-DD HH24:MI:SS.FFFFFF'),
'abca@123&^%djgk',INTERVAL '12-3' YEAR TO MONTH,lpad('abc','30','a@123&^%djgk'),65,'01010101',lpad('abc','300','a@123&^%djgk'),45,'DEADBEEF','fdfgdfg',0.0000023,1222.12,1234.12,
rpad('abc','10','&'),lpad('abc','10','&'),'abc&GDsh',125563.141592,rpad('abc','10','e'),'2019-01-03 14:14:12','a@123汉字&^%djgk',
+2,-1.79E+100,98*0.99,'1010101001010','abca@123&^%djgk','abca@123&^%djgk','2019-01-03 14:14:12',25563.1415,'a字符串@123&^%djgk','a字符串@123&^%djgk','101010101','2019-01-03 14:14:12','101010101','','2019-01-03 14:14:12');
--查询
